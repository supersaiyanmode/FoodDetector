...
# Define source files
SRCS = ./src/Classifier.cpp ./src/NearestNeighbor.cpp ./src/SVM.cpp ./src/BOVSVM.cpp ./src/BaseSVM.cpp ./src/DeepSVM.cpp ./src/utils.cpp ./src/EigenSVM.cpp ./src/SiftSVM.cpp ./src/HaarSVM.cpp ./a3.cpp ./siftpp/sift.cpp 
